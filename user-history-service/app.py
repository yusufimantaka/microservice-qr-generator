    ...
    while True:
        try:
            ...
            for msg in consumer:
                ...
                cache.delete(f"history:{event.get('user_id')}")
        except Exception as e:
            print(f"[ERROR] Kafka consumer failed: {e}. Retrying in 5s...")
            time.sleep(5)
...
def get_history():
    ...
    result = {"records": records, "page": page, "limit": limit}
...
def get_stats():
    ...
    return jsonify({"user_id": user_id, "total_generations": total})
